...
export class TicketResolver {
  ...
  async getTicket(
    ...
    return await ticketService.getTicket(ticketId, userId);
  }
  @Mutation(() => Ticket)
  ...
  async updateTicket(
    ...
    if (
      ...
      (assigneeId && !assigneeById)
    ) {
      throw new UserInputError("Invalid argument value", {
        argumentName:
          ticketById === null ? ARGUMENT_NAME.TICKET_ID : ARGUMENT_NAME.ID,
      });
    }
